...
let citationDisplay = document.getElementById('citation');
...
button.addEventListener('click', () => {
    ...
    citationDisplay.textContent = citations[nombreAleatoire][0];
...
let citations = [
    ...
    ["Nos connaissances sont une goutte, notre ignorance, un océan.", "Isaac Newton"],
    ["La vie, c'est comme une bicyclette, il faut avancer pour ne pas perdre l'équilibre.","Albert Einstein"],
    ["N'essayez pas de devenir un homme qui a du succès. Essayez de devenir un homme qui a de la valeur.","Albert Einstein"],
    ["La technique résout les problèmes et apporte des satisfactions mais elle n’est qu’un moyen et reste pauvre si on la sépare de l’esprit qui la guide.","Gaston Rébuffat"],
    ["La vie, en définitive, n'a de sens que si on la vit en se donnant à fond, en cherchant à réaliser tout ce qu'on a en soi.","Walter Bonatti"]
  ];
